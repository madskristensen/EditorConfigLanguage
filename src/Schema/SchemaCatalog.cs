...
namespace EditorConfig
{
    public class SchemaCatalog
    {
        ...
        public static IEnumerable<Property> Properties { get; } = GetProperties();
        ...
        {
            yield return new Severity("none", Resources.Text.SeverityNone, KnownMonikers.None);
            yield return new Severity("suggestion", Resources.Text.SeveritySuggestion, KnownMonikers.StatusInformation);
            yield return new Severity("warning", Resources.Text.SeverityWarning, KnownMonikers.StatusWarning);
            yield return new Severity("error", Resources.Text.SeverityError, KnownMonikers.StatusError);
        }

        public static bool TryGetProperty(string name, out Property property)
        {

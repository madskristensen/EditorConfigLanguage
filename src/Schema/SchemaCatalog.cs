...
namespace EditorConfig
{
    public static class SchemaCatalog
    {
        ...
        private static IEnumerable<Keyword> GetUnsupportedProperties()
        {
            ...
            yield return new Keyword("csharp_new_line_before_catch", desc, category, "true", "false", "all");
            yield return new Keyword("csharp_new_line_before_else", desc, category, "true", "false", "all");
            yield return new Keyword("csharp_new_line_before_finally", desc, category, "true", "false", "all");
            yield return new Keyword("csharp_new_line_before_members_in_anonymous_types", desc, category, "true", "false", "all");
            yield return new Keyword("csharp_new_line_before_members_in_object_initializers", desc, category, "true", "false", "all");
            yield return new Keyword("csharp_new_line_before_open_brace", desc, category, "true", "false", "all");
            yield return new Keyword("csharp_new_line_between_query_expression_clauses", desc, category, "true", "false", "all");
